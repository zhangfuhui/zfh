...
public class GenEntityOracle {
    ...
    private String packageOutPath = "main.java.com.bawei.entity";// 指定实体生成所在包的路径
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("dianying","Dianying","xiaoyi").init();  
        new GenEntityOracle("zhong","Zhong","xiaoyi").init();  
        new GenEntityOracle("fenlei","Fenlei","xiaoyi").init();  
    }  
}